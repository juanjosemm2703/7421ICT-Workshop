...
function accountGenerator(accountName, initBalance) {
  return (amount) => `You deposited ${amount} to your ${accountName} Account and the current balance is ${initBalance += amount}.`;
}
...
function greetingGenerator(defaultGreeting = "Hello") {
  return (name,greeting)=>`${greeting || defaultGreeting}, ${name}!`
}
